    ...
    <div className="room-panel">
      ...
      <div className="room-grid">
        ...
        <div className="room-row">
          ...
          <span className="room-value">Destructible</span>
        </div>
      </div>
      <div className="room-slots">
        {renderSlot(1, props.formState.playerOneName, props.formState.playerOneMobile)}
        {renderSlot(2, props.formState.playerTwoName, props.formState.playerTwoMobile)}
      </div>
    </div>
  );
}

function renderSlot(slot: 1 | 2, name: string, mobileType: MobileType): React.JSX.Element {
  return (
    <div className={getRoomSlotClassName(slot)}>
      ...
      <div className="room-slot-copy">
        ...
        <span className="room-slot-mobile">{getRoomMobileLabel(mobileType)}</span>
      </div>
